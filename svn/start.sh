#!/usr/bin/env bash
# start.sh — set up an SVN repo + working copy under ./svn for the
...
echo
echo "Done. Use ./svn/scenario-a-out-of-order.sh or ./svn/scenario-b-in-order.sh next."
